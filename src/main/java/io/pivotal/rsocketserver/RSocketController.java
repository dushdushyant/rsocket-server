...
import io.pivotal.rsocketserver.data.MyCustomBean;
...
public class RSocketController {
    ...
    @MessageMapping("request-custom-response")
    Message requestResponse(final MyCustomBean request) {
        log.info("Received request-response request: {}", request);
        // create a single Message and return it
        return new Message(SERVER, RESPONSE);
    }
    ...
    @MessageMapping("request-my-response")
    Mono<Message> requestMyResponse(final MyCustomBean request) {
        log.info("Received request-response request: {}", request);
        // create a single Message and return it
    ...
    @MessageMapping("request-dummy-response")
    Mono<Message> requestDummy(final String request) {
        log.info("Received request-response request: {}", request);
        // create a single Message and return it
